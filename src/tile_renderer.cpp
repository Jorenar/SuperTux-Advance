...
void TileRenderer::set_tilemap(uint8_t layer_num, TileMap* tilemap_)
{
    layers[layer_num].tilemap = tilemap_;
}

void TileRenderer::done()
{
...
void TileRenderer::set_tilemap_offset(uint8_t layer_num, int16_t x_offset, int16_t y_offset)
{
...
void TileRenderer::get_tilemap_offset(uint8_t layer_num, int16_t& x_offset, int16_t& y_offset)
{
    x_offset = layers[layer_num].x_offset;
    y_offset = layers[layer_num].y_offset;
}

void TileRenderer::copy_tilemap(uint8_t layer_num)
{
    Layer& layer = layers[layer_num];
